...
\*******************************************************************/
	...
	virtual void init(int t_start, int t_stop, 
			  value_type const& Vstart, value_type const& Vstop) = 0;
...
\*******************************************************************/
	...
	Interpolator<math_types, value_type> const& 
	operator=(Interpolator<math_types, value_type> const& new_interpolator)
        {}
