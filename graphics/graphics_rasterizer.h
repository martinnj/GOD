...
namespace graphics
{
	...
	{
	    throw std::logic_error("Rasterizer::init(2 x vector3_type&): No Point Rasterizer loaded.");
	}
	...
	{
	    throw std::logic_error("Rasterizer::init(4 x vector3_type&): No Line Rasterizer loaded.");
	}
	...
	{
	    throw std::logic_error("Rasterizer::init(12 x vector3_type&): No Triangle Rasterizer loaded.");
	}
